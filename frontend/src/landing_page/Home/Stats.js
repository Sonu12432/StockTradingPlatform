    ...
    <div className="container p-3">
      <div className="row p-5">
        <div className="col-6">
          ...
          <p className="text-muted lh-base">
            With initiatives like <a href="#" style={{ textDecoration: "none" }}>Nudge</a> and <a href="#" style={{ textDecoration: "none" }}>Kill Switch</a>, we don't just facilitate transactions, but actively help you do better with your <m>                                                                                                                                                                                                                                                                                                                                                                                                                                       </m>oney.
          </p>
        </div>
